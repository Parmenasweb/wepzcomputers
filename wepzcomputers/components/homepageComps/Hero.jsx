...
export default function Hero() {
  return (
    <div className="relative isolate px-6 pt-14 lg:px-8">
      ...
      <div className="mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 items-center py-32 sm:py-32 lg:pt-32 lg:pb-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center md:text-center flex-1">
          ...
          <h1 className="text-balance text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold tracking-tight text-gray-900 dark:text-gray-100">
            Fast & Reliable Laptop Repairs. Custom PC Builds and Upgrades
            Tailored just for You...
          </h1>
          <p className="mt-4 md:mt-6 text-base md:text-lg leading-7 md:leading-8 text-gray-600 dark:text-gray-300">
            Affordable repairs, professional upgrades, and custom builds made
          ...
          <div className="mt-8 md:mt-10 flex flex-col sm:flex-row items-center justify-start md:justify-center gap-4 sm:gap-x-6">
            ...
            <Link
              href="/contact"
              className="w-full sm:w-auto text-center sm:text-left text-sm font-semibold leading-6 text-gray-900 dark:text-gray-100 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors duration-300"
            >
              Contact Us{" "}
        ...
        <div className="image-section mt-8 md:mt-0 md:ml-8 flex-shrink-0">
          <div className="grid grid-cols-2 grid-rows-2 gap-4 ">
            <div className="col-span-2 row-span-1 h-[250px] relative">
              <Image
